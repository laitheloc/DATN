      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <router-link to="/products" class="text-gray-300 hover:text-white transition-colors">
                Sản phẩm
              </router-link>
            </li>
            <li>
            ...
            <li>
              <router-link to="/orders" class="text-gray-300 hover:text-white transition-colors">
                Đơn hàng
              </router-link>
            </li>
          </ul>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-gray-400 text-sm">
            © {{ currentYear }} Electronics Store. Tất cả quyền được bảo lưu.
          </p>
